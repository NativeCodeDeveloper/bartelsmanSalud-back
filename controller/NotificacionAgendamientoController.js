          ...
          return res.send(`
            ...
            <body>
              <div class="container">
                ...
                <p>Tu cita para el <strong>${new Date(fechaInicio + "T00:00:00").toLocaleDateString("es-CL", { weekday: "long", year: "numeric", month: "long", day: "numeric" })}</strong> a las <strong>${horaInicio}</strong> ha sido confirmada exitosamente.</p>
          ...
          return res.send(`
            ...
            <body>
              <div class="container">
                ...
                <p><strong>${nombrePaciente} ${apellidoPaciente}</strong></p>
                <p>Tu cita para el <strong>${new Date(fechaInicio + "T00:00:00").toLocaleDateString("es-CL", { weekday: "long", year: "numeric", month: "long", day: "numeric" })}</strong> a las <strong>${horaInicio}</strong> ha sido cancelada.</p>
